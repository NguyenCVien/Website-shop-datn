...
public class AccountServiceImpl implements AccountService {
    ...
    // reset password
    public void updateResetPassword(String token, String username) throws AccountNotFoundException {
        ...
        if (account != null) {
            ...
            throw new AccountNotFoundException("Account not find any Account with username " + username);
        }
    }

    public Account get(String resetPasswordToken) {
        return accountService.findByResetPasswordToken(resetPasswordToken);
    }
    ...
    public Account findByResetPasswordToken(String token) {
        return accountService.findByResetPasswordToken(token);
    }
