...
public class AccountServiceImpl implements AccountService {
    ...
    // reset password
    public void updateResetPassword(String token, String username, Model model) {
        Account account = accountService.findByUsernameId(username);
    ...
    public Account findByUsernameId(String username) {
        return adao.findByUsernameId(username);
    }
