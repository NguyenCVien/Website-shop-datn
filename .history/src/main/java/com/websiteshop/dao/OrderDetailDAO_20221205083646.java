...
public interface OrderDetailDAO extends JpaRepository<OrderDetail, Long> {
	...
	@Query("SELECT o FROM Orders AS OD INNER JOIN o.Accounts AS Acc ON OD.Username = Acc.Username inner join o.OrderDetails as odt on OD.OrderId = odt.OrderId WHERE o.status =?1")
