...
public interface OrderDetailDAO extends JpaRepository<OrderDetail, Long> {
	...
	@Query("SELECT o FROM Order AS OD INNER JOIN o.Account AS Acc ON OD.Username = Acc.Username inner join o.OrderDetail as odt on OD.OrderId = odt.OrderId WHERE o.status =?1")
