...
public interface OrderDetailDAO extends JpaRepository<OrderDetail, Long> {
	...
	// @Query(value = "SELECT Status = N'Đang vận chuyển',Discount, Price,
	// OrderDetailId, Username, CreateDay, TelePhone, Address, Name, Email FROM
	// OrderDetails odt inner join Orders od on odt.OrderId = od.OrderId WHERE
